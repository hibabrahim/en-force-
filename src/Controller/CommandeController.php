...
//        );
     ...
     */
    public function mesCommande(Request $request, CommandeRepository $commandeRepository): Response
    {
    ...
    public function placeOrder(\App\Service\CartService1 $cartService, \App\Service\CommandeService $commandeService, MailerInterface $mailer)
    {
        ...
        $cartService->clear();
        $email = (new Email())
        ->from('hibabr717@gmail.com')
        ->to('Hiba.Brahim@esprit.tn')
...
<table role='presentation' border='0' cellpadding='0' cellspacing='0' class='body'>
  <tr>
    ...
    public function new(Request $request, CommandeRepository $commandeRepository): Response
    {
     ...
     /**
     * @Route("/news", name="app_commande_news", methods={"GET", "POST"})
     */
    public function news(Request $request, CommandeRepository $commandeRepository): Response
    {
        $commande = new Commande();
        $form = $this->createForm(CommandeType::class, $commande);
        $form->handleRequest($request);
        ...
        return $this->renderForm('commande/news.html.twig', [
            'commande' => $commande,
            'form' => $form,
        ]);
    }
     ...
     */
    public function edit(Request $request, $idC, CommandeRepository $commandeRepository): Response
     ...
     */
    public function delete(Request $request, $idC, CommandeRepository $commandeRepository, EntityManagerInterface $entityManager): Response
    {
      $commande = $commandeRepository->find($idC);
     ...
     */
    public function deletefront(Request $request, $idC, CommandeRepository $commandeRepository, EntityManagerInterface $entityManager): Response
    {  
        $commande = $commandeRepository->find($idC);
