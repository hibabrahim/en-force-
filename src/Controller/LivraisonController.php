...
class LivraisonController extends AbstractController
{
     ...
     */
    public function editBack( $id, Request $request, LivraisonRepository $livraisonRepository): Response
     ...
     */
    public function editconfrim($id, Request $request, LivraisonRepository $livraisonRepository): Response
    {  
          $livraison=$livraisonRepository->find($id);
     ...
     */
    public function delete(Request $request,  $id, LivraisonRepository $livraisonRepository,EntityManagerInterface $entityManager): Response
    {
